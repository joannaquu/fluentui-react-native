...
export const ContextualMenuTest: React.FunctionComponent = () => {
  ...
  const links = {
    Usage:
      'https://github.com/microsoft/fluentui-react-native/blob/main/apps/fluent-tester/src/TestComponents/ContextualMenu/ContextualMenuTest.tsx',
  };

  return <Test name="ContextualMenu Test" description={description} links={links} sections={contextualMenuSections} status={status}></Test>;
};
