...
export const LinkTest: React.FunctionComponent = () => {
  ...
  const links = {
    Usage: 'https://github.com/microsoft/fluentui-react-native/blob/main/apps/fluent-tester/src/TestComponents/Link/LinkTest.tsx',
  };

  return <Test name="Link Test" description={description} links={links} sections={linkSections} status={status}></Test>;
};
