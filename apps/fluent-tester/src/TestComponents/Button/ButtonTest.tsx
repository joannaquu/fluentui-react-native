...
export const ButtonTest: React.FunctionComponent = () => {
  ...
  const links = {
    SPEC: 'https://github.com/microsoft/fluentui-react-native/blob/main/packages/components/Button/SPEC.md',
    Usage:
      'https://github.com/microsoft/fluentui-react-native/blob/main/apps/fluent-tester/src/TestComponents/Button/ButtonVariantTestSection.tsx',
  };

  return <Test name="Button Test" description={description} links={links} sections={buttonSections} status={status} />;
};
