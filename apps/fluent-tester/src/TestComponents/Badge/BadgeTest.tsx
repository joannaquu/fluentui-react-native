...
export const BadgeTest: React.FunctionComponent = () => {
  ...
  const links = {
    SPEC: 'https://github.com/microsoft/fluentui-react-native/blob/main/packages/experimental/Badge/SPEC.md',
    Usage: 'https://github.com/microsoft/fluentui-react-native/blob/main/apps/fluent-tester/src/TestComponents/Badge/BasicBadgeTest.tsx',
  };

  return <Test name="Badge Test" description={description} links={links} sections={badgeSections} status={status} />;
};
